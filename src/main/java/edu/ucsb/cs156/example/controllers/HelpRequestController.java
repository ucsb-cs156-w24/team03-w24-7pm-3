...
public class HelpRequestController extends ApiController {
    ...
    public HelpRequest postHelpRequest(
            ...
            @Parameter(name="requestTime", description = "(in iso format, e.g. YYYY-mm-ddTHH:MM:SS, eg: 2015-05-03T10:15:30; see https://en.wikipedia.org/wiki/ISO_8601)") @RequestParam("requestTime") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime requestTime,
