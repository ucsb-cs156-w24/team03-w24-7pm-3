...
describe("MenuItemReviewTable tests", () => {
    ...
    const expectedHeaders = ["id", "Menu Item ID", "Email", "Stars", "Date", "Comments"];
    ...
    test("Has the expected column headers, content and buttons for admin user", () => {
        ...
        expect(screen.getByTestId(`${testId}-cell-row-1-col-reviewerEmail`)).toHaveTextContent("delplaya@ucsb.edu");

        expect(screen.getByTestId(`${testId}-cell-row-2-col-id`)).toHaveTextContent("3");
        expect(screen.getByTestId(`${testId}-cell-row-2-col-itemId`)).toHaveTextContent("3");
        expect(screen.getByTestId(`${testId}-cell-row-2-col-reviewerEmail`)).toHaveTextContent("testemail@ucsb.edu");
    ...
    test("Delete button calls delete callback", async () => {
        ...
        expect(screen.getByTestId(`${testId}-cell-row-0-col-comments`)).toHaveTextContent("Tastes Great!");
        const deleteButton = screen.getByTestId(`${testId}-cell-row-0-col-Delete-button`);
        expect(deleteButton).toBeInTheDocument();
